...
const MemberView = () => {
    ...
    const [userDetails, setUserDetails] = useState<{user_id: string, user_email:string, bio:string, internship:string,first_name: string, last_name:string, year: string, major:string, contact_me: string, hours:string}>({
        user_id: "",
        user_email: "",
        bio: "",
        internship: "",
