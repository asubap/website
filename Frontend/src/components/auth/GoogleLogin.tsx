...
const GoogleLogin = () => {
    ...
    return (
        <div className="flex flex-col items-center">
            ...
            <button onClick={handleGoogleLogin} className="p-2 md:p-4 rounded-lg text-xl flex items-center justify-center gap-4 bg-white text-black hover:bg-gray-100 transition-colors">
